...
<style>
    ...
    .tab-share .ivu-table:before, .tab-share .ivu-table:after{
        background-color: transparent;
    }
    .tab-share  .ivu-table-fixed-right::before, .tab-share  .ivu-table-fixed::before {
        background-color: transparent;
    }
    .tab-share .ivu-table td, .ivu-table th {
        border-bottom: 0;
    }
    .tab-share .not-data {
        overflow: hidden;
